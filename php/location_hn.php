...
echo '<option value="">शहर चुनें</option>';
...
echo '<option value="">शहर उपलब्ध नहीं है</option>';
}
}
//error_reporting(0);
?>