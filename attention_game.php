...
<html>
  ...
  <body>
    <div class="body">
      ...
      <div role="main" class="main">
        <section class="page-header">
          <div class="container">
            ...
            <div class="row">
              <div class="col">
                <h1>Corsi Block Tapping Test - Practice</h1>
              </div>
            </div>
          </div>
        </section>
        <div class="container">
          <div id="intro" class="row img-fluid appear-animation animated fadeInRightBig appear-animation-visible" data-appear-animation="fadeInRightBig" data-appear-animation-delay="0" data-appear-animation-duration="1s" style="animation-duration: 1s; animation-delay: 0ms;">
            <div class="col-lg-12 text-center" >
              ...
              <h2>The Corsi Block Tapping Test developed by <strong>B. Milner (1971)</strong> is a test to measure visuospatial recall. In this test you will see <strong>3 blocks</strong> which will light up in a sequence. Tap the blocks in the sequence suggested to win.</h2>
      ...
      litpicid = _.sampleSize(picturesid, 3);
      setTimeout(function () {
      ...
      } else if(tosave.length == 2) {
      $(this).attr("src","img/box-lit.png");
      var divtobesaved = $(this).attr("id");
      tosave.push(divtobesaved);
      if (sequence == 1) {
      if ((litpicid[0] == "#"+tosave[0]) && (litpicid[1] == "#"+tosave[1]) && (litpicid[2] == "#"+tosave[2])) {
      score = 1;
      ...
      if ((litpicid[0] == "#"+tosave[2]) && (litpicid[1] == "#"+tosave[1]) && (litpicid[2] == "#"+tosave[0])){
      score = 1;
      message = "right answer ";
      } else {
      score = 0;
