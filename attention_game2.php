...
<html>
  ...
  <body>
    <div class="body">
          ...
          <div id="intro" class="row img-fluid appear-animation animated fadeInRightBig appear-animation-visible" data-appear-animation="fadeInRightBig" data-appear-animation-delay="0" data-appear-animation-duration="1s" style="animation-duration: 1s; animation-delay: 0ms;">
            <div class="col-lg-12 text-center" >
              <div class="heading heading-border heading-bottom-border">
                <h2>Four Block Test</h2>
              </div>
              <h2>The Corsi Block Tapping Test developed by <strong>B. Milner (1971)</strong> is a test to measure visuospatial recall. In this test you will see <strong>4 blocks</strong> which will light up in a sequence. Tap the blocks in the sequence suggested to win.</h2>
      ...
      litpicid = _.sampleSize(picturesid, 4);
      setTimeout(function () {
      ...
      if ((litpicid[0] == "#"+tosave[3]) && (litpicid[1] == "#"+tosave[2]) && (litpicid[2] == "#"+tosave[1]) && (litpicid[3] == "#"+tosave[0])){
      score = 1;
      message = "right answer ";
      } else {
      score = 0;
