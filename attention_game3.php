...
<html>
  ...
  <body>
    <div class="body">
          ...
          <div id="intro" class="row img-fluid appear-animation animated fadeInRightBig appear-animation-visible" data-appear-animation="fadeInRightBig" data-appear-animation-delay="0" data-appear-animation-duration="1s" style="animation-duration: 1s; animation-delay: 0ms;">
            <div class="col-lg-12 text-center" >
              <div class="heading heading-border heading-bottom-border">
                <h2>Five Block Test</h2>
              </div>
              <h2>In this test you will see <strong>5 blocks</strong> which will light up in a sequence. Tap the blocks in the sequence suggested to win.</h2>
      ...
      litpicid = _.sampleSize(picturesid, 5);
      setTimeout(function () {
      ...
      } else if(tosave.length == 4) {
      $(this).attr("src","img/box-lit.png");
      var divtobesaved = $(this).attr("id");
      tosave.push(divtobesaved);
      $("#myModal2").modal("show");
      if (sequence == 1) {
      if ((litpicid[0] == "#"+tosave[0]) && (litpicid[1] == "#"+tosave[1]) && (litpicid[2] == "#"+tosave[2]) && (litpicid[3] == "#"+tosave[3]) && (litpicid[4] == "#"+tosave[4])) {
      score = 1;
      ...
      if ((litpicid[0] == "#"+tosave[4]) && (litpicid[1] == "#"+tosave[3]) && (litpicid[2] == "#"+tosave[2]) && (litpicid[3] == "#"+tosave[1]) && (litpicid[4] == "#"+tosave[0])){
      score = 1;
      message = "right answer ";
      } else {
      score = 0;
