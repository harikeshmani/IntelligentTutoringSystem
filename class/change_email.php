...
$row = mysqli_fetch_array(mysqli_query($link,"SELECT email FROM tbl_glow_students WHERE id='$user_id'"));
$oldemail= $row[0];
...
mysqli_query($link,"UPDATE tbl_glow_students SET email = '$newemail' WHERE id='$user_id'");
if(mysqli_affected_rows($link)==0) {
$msg="<span style='color:red'>Error in Upadation.</span>";
}  else {
