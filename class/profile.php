							...
							<div class="col-lg-4">
								<span class="thumb-info thumb-info-hide-wrapper-bg">
									<span class="thumb-info-wrapper">
										<img src="../api/user_image/<?php echo $picture; ?>" class="img-fluid" alt=<?php echo $userfetch_data['username']; ?> "image" height="100" width="100">
							...
							<div class="col">
								...
								<div class="row">
										...
										<div class="tabs tabs-vertical tabs-left tabs-navigation">
											<ul class="nav nav-tabs col-sm-3">
												<li class="nav-item active">
													<a class="nav-link show active" href="#tabsNavigation1" data-toggle="tab"><i class="fas fa-users"></i>class Information</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" href="#tabsNavigation2" data-toggle="tab"><i class="fas fa-address-book"></i>class Address</a>
												</li>
											</ul>
										</div>
									</div>
									<div class="col-lg-8">
										...
										<button type="button" class="btn btn-primary btn-xl mb-2 m-4" data-toggle="tooltip" data-placement="top" title="" data-original-title="Upadate my profile" id="final-submit">
										Update Profile
										</button>
									</div>
								</div>
