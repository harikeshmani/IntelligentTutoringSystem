...
$row = mysqli_fetch_array(mysqli_query($link,"SELECT username FROM tbl_glow_students WHERE id='$user_id'"));
$name= $row[0];
...
mysqli_query($link,"UPDATE tbl_glow_students SET username = '$newname' WHERE id='$user_id'");
                    ...
                    <div class="box-content" style="background-color: #1b68b2;">
                      ...
                      <form action="" method="post" name="form1" id="changename" class="form-horizontal" role="form">
                          ...
                          <label>Old Name:</label>
                            <input class="form-control form-control-lg" type="text" value="<?php echo $name; ?>" name="name" readonly>
                          </div>
                        </div>
