...
$sender_data = mysqli_fetch_array(mysqli_query($link, "SELECT username, pic FROM tbl_glow_students WHERE id = '$student_id'"));
$name_sender = $sender_data['username'];
$pic = $sender_data['pic'];
$pic_sender = '../api/user_image/'.$pic;
